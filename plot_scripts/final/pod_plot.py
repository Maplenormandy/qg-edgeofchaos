...
fig = plt.figure(figsize=(13.0/2.54, 13.0*0.36/2.54), dpi=100)


gs_over = fig.add_gridspec(1, 3, width_ratios=[1,0.1,1])
...
for i in range(len(cases)):
    ...
    gs = gs_over[2*i].subgridspec(2, 3, wspace=0.0, height_ratios=[0.8,0.2])
